...
<p style="font-family:b nazanin;font-size:15px;text-align: justify; width: 70%; color: #ee0101; margin: 0 auto;">
	...
	<br>
    <b style="font-size:140%;color: red">
- با توجه به مشکل پیش آمده در سیستم بانکی شرکت تجارت الکترونیک پارسیان لطفا" تا اطلاع ثانوی از اعتبار تجارت الکترونیک و دستگاه pos استفاده ننمایید.
امکان استفاده از بانک ملت و بانک تجارت در سیستم کماکان پابرجا میباشد.
<br>
جهت جلوگیری از بسته شدن سیستم خود می توانید  صرفا  مبالغ حق بیمه با شناسه پرداخت های دریافتی به حساب تجارت الکترونیک پارسیان را   به صورت موقت و تا رفع مشکلات دستگاههای پوز  به شماره حساب بانک تجارت -سپهبد قرنی (17123130)بیمه پارسیان واریز نمایید.
<br>
با تشکر
	...
	<br>
    <b style="font-size:100%;color: green">
- به استحضار كاربران محترم  مي رساند امكان پرداخت اينترنتي بدهي هاي سند نخورده  از مسير "عمليات مالي-مشاهدات-پرداخت اينترنتي بدهي" در سيستم سنام فراهم شده است
    ...
    <br>
    <br>
    <b style="font-size:100%;color: #0000ff">
...
<p style="font-family:b nazanin;font-size:15px;text-align: justify; width: 70%; color: #111111; margin: 0 auto;">
    <b style="font-size:100% ; color: #ee0101">
          - جهت تسريع در پاسخگويي به مشکلات و سوالات خود در ارتباط با سيستم خواهشمند است از سامانه تيکت (به آدرس
              <b><a href="http://ticket.parsianinsurance.com">http://ticket.parsianinsurance.com</a></b>
          )        استفاده نماييد. و از تماس تلفني با مرکز جدا خودداري نماييد. درصورت عدم رفع مشکل با توجه به راهنمايي هاي دريافتي در سامانه تيکت با شماره مستقیم 42169100 تماس حاصل نماييد.
    </b>
    <br>
    <b style="font-size:100%">
