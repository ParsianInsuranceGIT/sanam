...
<b>
<%--	<p style="font-family:b nazanin;font-size:15px;text-align: center; width: 100%; color:  #000000; margin: 0 auto;"> --%>
<%--	<p style="font-family:b nazanin;font-size:19px;text-align: center; width: 70%; color:  #ee0101; margin: 0 auto;"> --%>

<%--به اطلاع نمايندگان محترم مي رساند--%>
<%--مواردي از اقساط پرداخت شده اينترنتي كه كارمزد آنها پرداخت نشده است در پروژه كارمزد اين ماه(93/09/01) پرداخت  خواهد شد.--%>
	<%--</p>
<%--</b>
<br/>
<%--<br/>--%>
