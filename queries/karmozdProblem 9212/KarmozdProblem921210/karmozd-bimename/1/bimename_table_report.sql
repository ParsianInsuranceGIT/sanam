...
b.bimename_karmozd, trunc((((nvl(gb.majmoo_amount,0) - nvl(gb.majmoo_maliat,0) - nvl(gb.majmoo_ezafi,0)) + replace(nvl(es.mablagh_sepor_ebted_sal,0),',')) * 0.75)) Haftad5DarsadBime 
...
and 
    ...
    and trunc((((nvl(gb.majmoo_amount,0) - nvl(gb.majmoo_maliat,0) - nvl(gb.majmoo_ezafi,0)) + replace(nvl(es.mablagh_sepor_ebted_sal,0),',')) * 0.75))<>b.bimename_karmozd
    and trunc((((nvl(gb.majmoo_amount,0) - nvl(gb.majmoo_maliat,0) - nvl(gb.majmoo_ezafi,0)) + replace(nvl(es.mablagh_sepor_ebted_sal,0),',')) * 0.75))+1<>b.bimename_karmozd
    and trunc((((nvl(gb.majmoo_amount,0) - nvl(gb.majmoo_maliat,0) - nvl(gb.majmoo_ezafi,0)) + replace(nvl(es.mablagh_sepor_ebted_sal,0),',')) * 0.75))-1<>b.bimename_karmozd
group by b.bimename_id,p.id,b.bimename_tarikhsodur,(nvl(es.sarmaye_paye_fot_long,0) * 0.03) ,b.bimename_karmozd, trunc((((nvl(gb.majmoo_amount,0) - nvl(gb.majmoo_maliat,0) - nvl(gb.majmoo_ezafi,0)) + replace(nvl(es.mablagh_sepor_ebted_sal,0),',')) * 0.75))       
;
