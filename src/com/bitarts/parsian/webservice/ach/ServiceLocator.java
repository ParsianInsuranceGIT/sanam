...
public class ServiceLocator extends org.apache.axis.client.Service implements com.bitarts.parsian.webservice.ach.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://172.16.0.37/ACHWebService/Service.asmx";
    ...
    public com.bitarts.parsian.webservice.ach.ServiceSoap_PortType getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bitarts.parsian.webservice.ach.ServiceSoap_BindingStub _stub = new com.bitarts.parsian.webservice.ach.ServiceSoap_BindingStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "http://172.16.0.37/ACHWebService/Service.asmx";
    ...
    public com.bitarts.parsian.webservice.ach.ServiceSoap_PortType getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bitarts.parsian.webservice.ach.ServiceSoap12Stub _stub = new com.bitarts.parsian.webservice.ach.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bitarts.parsian.webservice.ach.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bitarts.parsian.webservice.ach.ServiceSoap_BindingStub _stub = new com.bitarts.parsian.webservice.ach.ServiceSoap_BindingStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (com.bitarts.parsian.webservice.ach.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bitarts.parsian.webservice.ach.ServiceSoap12Stub _stub = new com.bitarts.parsian.webservice.ach.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.ACH.parsianInsurance.ir/", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.ACH.parsianInsurance.ir/", "ServiceSoap"));
            ports.add(new javax.xml.namespace.QName("http://www.ACH.parsianInsurance.ir/", "ServiceSoap12"));
        }
