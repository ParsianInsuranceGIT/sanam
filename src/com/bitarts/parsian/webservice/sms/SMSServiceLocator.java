...
public class SMSServiceLocator extends org.apache.axis.client.Service implements SMSService {
    ...
    private java.lang.String ServiceSoap_address = "http://172.16.0.37/smswebservice/service.asmx";
    ...
    public SMSServiceSoap_PortType getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public SMSServiceSoap_PortType getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            SMSSMSServiceSoap_BindingStub _stub = new SMSSMSServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SMSServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                SMSSMSServiceSoap_BindingStub _stub = new SMSSMSServiceSoap_BindingStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.SMS.parsianInsurance.ir/", "SMSService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.SMS.parsianInsurance.ir/", "ServiceSoap"));
        }
