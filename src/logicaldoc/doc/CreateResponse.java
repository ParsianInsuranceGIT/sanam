...
public class CreateResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the document value for this CreateResponse.
     * 
     * @return document
     */
    ...
    /**
     * Sets the document value for this CreateResponse.
     * 
     * @param document
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://document.webservice.logicaldoc.com/", "createResponse"));
