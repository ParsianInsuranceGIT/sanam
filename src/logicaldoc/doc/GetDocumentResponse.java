...
public class GetDocumentResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the document value for this GetDocumentResponse.
     * 
     * @return document
     */
    ...
    /**
     * Sets the document value for this GetDocumentResponse.
     * 
     * @param document
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://document.webservice.logicaldoc.com/", "getDocumentResponse"));
