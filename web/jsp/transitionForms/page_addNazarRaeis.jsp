...
<%
    ...
    Integer sumup = (Integer) request.getAttribute("sumup");
%>
<head>
     <title>افزودن نظر</title>
</head>
    <form class="mainFrame" id="mainForm" method="post" action="/addRaeisNazar.action?pishnehadId=<%=request.getParameter("pishnehadId")%>&transitionId=<%=request.getParameter("transitionId")%>">
...
ثبت نظر
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="pezeshkSabtNazar.ezafeNerkh" id="pezeshkezafenerkh" value="<%=sumup%>"/>
            </td>
        </tr>
        <tr>
            <td colspan="2">
