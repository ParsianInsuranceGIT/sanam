		...
		switch (el.navtype) {
			...
			if (typeof text != "undefined") {
				...
				text = "Help and about box text is not translated into this language.\n" +
					"If you know this language and you feel generous please updatePishnehad\n" +
...
Calendar.prototype.create = function (_par) {
	...
	this._nav_py = hh("&#x00ab;", 1, 2);
	this._nav_py.ttip = Calendar._TT["NEXT_YEAR"];

	this._nav_pm = hh("&#x2039;", 1, 1);
	this._nav_pm.ttip = Calendar._TT["NEXT_MONTH"];

	this._nav_now = hh(Calendar._TT["TODAY"], this.weekNumbers ? 4 : 3, 0);
	this._nav_now.ttip = Calendar._TT["GO_TODAY"];

	this._nav_nm = hh("&#x203a;", 1, -1);
	this._nav_nm.ttip = Calendar._TT["PREV_MONTH"];

	this._nav_ny = hh("&#x00bb;", 1, -2);
	this._nav_ny.ttip = Calendar._TT["PREV_YEAR"];
