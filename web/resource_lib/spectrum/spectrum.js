...
//                "<input type='button' class='sp-choose' value=''/>",
                    "<input type='button' class='sp-cancel ui-state-default  ui-corner-all' value=''/>",
                    "<input type='button' class='sp-choose ui-state-default  ui-corner-all' value=''/>",
                    "</div>",
                    "</div>",
                    "</div>"
                ].join("");
